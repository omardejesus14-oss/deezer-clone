      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-5">
        ...
        <p className="text-center mt-10">No encontramos nada para "{search}"</p>
            ...
            >
              ...
              {/* BOTONES */}
              <div className="absolute bottom-3 right-3 flex items-center gap-2 opacity-100 flex gap-2 transition md:opacity-0 md:group-hover:opacity-100 transition-opacity">

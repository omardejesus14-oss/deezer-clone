      ...
      <div className="w-[93%] max-w-[1200px] mx-auto flex items-center justify-between px-0 md:px-6">
        ...
        <Link href="/">
          <img
            ...
            alt="Deezer Logo"
            className="w-[165px] md:w-[130px] ml-[-10px] md:ml-0 object-contain cursor-pointer"
          />
        </Link>
          ...
          <>
            ...
            <div className="hidden md:flex items-center gap-14">
              ...
              <div className="flex gap-4">
                <Link href="/login">
                  <button className="border border-[#3a3a44] text-white px-3 py-1 text-[12px] cursor-pointer hover:bg-[#444] rounded-md">
                    Iniciar sesión
                  </button>
                </Link>
                <Link href="/email">
                  <button className="bg-[#c438ff] text-white px-3 py-1 text-[12px] cursor-pointer hover:bg-[#a238ff] rounded-md">
                    Registrarse
                  </button>
                </Link>
              </div>
            ...
            <div className="flex items-center gap-3 md:hidden">
              <Link href="/email">
                <button className="bg-[#a238ff] text-white px-3 py-1 text-[12px] rounded-md font-bold">
                  Registrarse
                </button>
              </Link>
              <div 
